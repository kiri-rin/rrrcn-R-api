...
getwd()
SirvivalService <- function(df,output){
  ...
  fmla <- as.formula(paste(" ~ ", paste(colnames(rfData[,c(3:33)]), collapse= "+")))
  fmla
  ...
  markrun.nestall=function()
    {
    #myex0<-mark(final2,nocc=162,model = "Nest",model.parameters=list(S=list(formula=fmla)))
    #myex1<-mark(final2,nocc=162,model = "Nest", model.parameters=list(S=list(formula=~EVI082022+dist.Achr+EVI042022+EVI052022+EVI072022+WC_B100)))
    #myex2<-mark(final2,nocc=162,model = "Nest", model.parameters=list(S=list(formula=~EVI082022+dist.Achr+EVI042022+EVI052022+EVI072022)))
    #myex3<-mark(final2,nocc=162,model = "Nest", model.parameters=list(S=list(formula=~EVI082022+dist.Achr+EVI042022+EVI052022)))
    #myex4<-mark(final2,nocc=162,model = "Nest", model.parameters=list(S=list(formula=~EVI082022+dist.Achr+EVI042022)))
    #myex5<-mark(final2,nocc=162,model = "Nest", model.parameters=list(S=list(formula=~EVI082022+dist.Achr)))

    myex1<-mark(final2,nocc=162,model = "Nest", model.parameters=list(S=list(formula=~EVI082022+ dist.Achr +WC_B100+AgeDay1+tp06 )))
    myex2<-mark(final2,nocc=162,model = "Nest", model.parameters=list(S=list(formula=~EVI082022+ dist.Achr +WC_B100+AgeDay1)))
    myex3<-mark(final2,nocc=162,model = "Nest", model.parameters=list(S=list(formula=~EVI082022+ dist.Achr +WC_B100)))

    #myex6<-mark(final2,nocc=162,model = "Nest", model.parameters=list(S=list(formula=~EVI082022)))
    #myex7<-mark(final2,nocc=162,model = "Nest", model.parameters=list(S=list(formula=~1)))

    return(collect.models() )
  }

  nest.results=markrun.nestall()
  nest.results
  nest.results[[7]]

  result <-nest.results[[6]]
  result$results
